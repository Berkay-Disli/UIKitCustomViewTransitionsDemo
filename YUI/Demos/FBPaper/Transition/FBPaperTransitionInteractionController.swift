...
class FBPaperTransitionInteractionController: NSObject {
    struct Context {
...
extension FBPaperTransitionInteractionController: UIViewControllerInteractiveTransitioning {
...
///
extension FBPaperTransitionInteractionController {
