...
final class UntitledTransitionAnimationController: NSObject {
    var transition: TransitionType = .push
    private var config: SharedTransitionConfig = .untitled
}

extension UntitledTransitionAnimationController: UIViewControllerAnimatedTransitioning {
...
extension UntitledTransitionAnimationController {
    ...
    private func setup(with context: UIViewControllerContextTransitioning) -> (UIView, CGRect, UIView, UIView, CGRect, UIView)?
    {
